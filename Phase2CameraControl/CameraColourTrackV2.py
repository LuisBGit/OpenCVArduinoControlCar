...
class myFilter:
    ...
    def lineCheck(self):
        ...
        if (self.target == True):
            ...
            print (angleOut1, angleOut2)
            if self.closeEnough(angleOut1, angleOut2, line1Length, line2Length):
                print("IN LINE")

    def closeEnough(self, angle1, angle2, Length1, Length2):
        lowerLimit1 = angle1 - 2
        upperLimit1 = angle1 + 2
